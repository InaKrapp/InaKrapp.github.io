...
The code (with extensive commentary) can be downloaded [here](Global_Temperature_prediction_model.qmd). It is written in a quarto document and should run on any relatively recent version of R and Rstudio. 
