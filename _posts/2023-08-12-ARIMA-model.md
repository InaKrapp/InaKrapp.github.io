...
The code (with extensive commentary) can be downloaded [here]([Global_Temperature_prediction_model.qmd](https://github.com/InaKrapp/InaKrapp.github.io/blob/master/_posts/Global_Temperature_prediction_model.qmd)). It is written in a quarto document and should run on any relatively recent version of R and Rstudio. 
The [Global Temperature.txt]([Global_Temperature.txt](https://github.com/InaKrapp/InaKrapp.github.io/blob/master/_posts/Global_Temperature.txt)) and [merged_ice_core_yearly.csv]([merged_ice_core_yearly.csv](https://github.com/InaKrapp/InaKrapp.github.io/blob/master/_posts/Global_Temperature.txt)) files contain the data the model uses, so they have to be downloaded to run the code as well.
