...
The code (with extensive commentary) can be downloaded [here]([https://github.com/InaKrapp/InaKrapp.github.io/raw/master/_posts/Global_Temperature_prediction_model.qmd](https://raw.githubusercontent.com/InaKrapp/Global_temperature_ARIMA_model/main/Global_Temperature_prediction_model.qmd)). It is written in a quarto document and should run on any relatively recent version of R and Rstudio. 
The [Global Temperature.txt]([https://github.com/InaKrapp/InaKrapp.github.io/raw/master/_posts/Global_Temperature.txt](https://raw.githubusercontent.com/InaKrapp/Global_temperature_ARIMA_model/main/Global_Temperature.txt)) and [merged_ice_core_yearly.csv](https://raw.githubusercontent.com/InaKrapp/Global_temperature_ARIMA_model/main/merged_ice_core_yearly.csv)) files contain the data the model uses, so they have to be downloaded to run the code as well.
