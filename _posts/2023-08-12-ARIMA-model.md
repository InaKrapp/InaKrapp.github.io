...
The [Global Temperature.txt](Global_Temperature.txt) and [merged_ice_core_yearly.csv](merged_ice_core_yearly.csv) files contain the data the model uses, so they have to be downloaded to run the code as well.
